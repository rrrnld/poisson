...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6441_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6442 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6443 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6442);
var pos_6444 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6442);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6443);

var tr__6348__auto___6445 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6443) - cljs.core.first(pos_6444)),(((quil.core.height() / (2)) / zoom_6443) - cljs.core.second(pos_6444))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6348__auto___6445);
...
var G__6446 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6447 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6446,G__6447) : user_mouse_dragged.call(null,G__6446,G__6447));
...
return (function (state,event){
var G__6448 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6449 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6448,G__6449) : user_mouse_wheel.call(null,G__6448,G__6449));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
